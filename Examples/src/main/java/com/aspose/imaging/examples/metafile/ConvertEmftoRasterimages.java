...
public class ConvertEmftoRasterimages
{
    ...
    {
		Logger.startExample("ConvertEmftoRasterimages");
		...
		try (com.aspose.imaging.fileformats.emf.EmfImage image = (com.aspose.imaging.fileformats.emf.EmfImage) com.aspose.imaging.Image
				.load(dataDir + filePath))
		{
			// Convert EMF to BMP
			...
			image.save(outDir + filePath + "_out.bmp", objBMPo);
			...
			image.save(outDir + filePath + "_out.gif", objGIFo);
			...
			image.save(outDir + filePath + "_out.jpeg", objJPEGo);
			...
			image.save(outDir + filePath + "_out.j2k", objJpeg2o);
			...
			image.save(outDir + filePath + "_out.png", objPNGo);
			...
			image.save(outDir + filePath + "_out.psd", objPSDo);
			...
			image.save(outDir + filePath + "_out.tiff", objTIFFo);
			...
			image.save(outDir + filePath + "_out.webp", objWebPo);
		}
		Logger.endExample();
    }
