...
package programmerguide.drawingimages.drawimagesusingadvancedfunctionality.drawingusinggraphics.java;
...
public class DrawingusingGraphics
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmerguide/drawingimages/drawimagesusingadvancedfunctionality/drawingusinggraphics/data/";
